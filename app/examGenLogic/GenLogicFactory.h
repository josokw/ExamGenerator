#ifndef GENLOGICFACTORY_H
#define GENLOGICFACTORY_H
...
/// The class 'GenLogicFactory' is responsible for creating IGenerator derived
...
class GenLogicFactory final
{
public:
   GenLogicFactory();
   ~GenLogicFactory() = default;
